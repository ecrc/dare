...
// 141 is PlasmaLeft
#define FMULS_SYMM(__side, __m, __n) ( ( (__side) == 141 ) ? FMULS_GEMM((__m), (__m), (__n)) : FMULS_GEMM((__m), (__n), (__n)) )
#define FADDS_SYMM(__side, __m, __n) ( ( (__side) == 141 ) ? FADDS_GEMM((__m), (__m), (__n)) : FADDS_GEMM((__m), (__n), (__n)) )
...
#define FMULS_TRMM(__side, __m, __n) ( ( (__side) == 141 ) ? FMULS_TRMM_2((__m), (__n)) : FMULS_TRMM_2((__n), (__m)) )
#define FADDS_TRMM(__side, __m, __n) ( ( (__side) == 141 ) ? FADDS_TRMM_2((__m), (__n)) : FADDS_TRMM_2((__n), (__m)) )
...
#define FMULS_UNMQR(m_, n_, k_, side_) (( (side_) == 141 ) \
    ?  (2.*(n_)*(m_)*(k_) - (n_)*(k_)*(k_) + 2.*(n_)*(k_)) \
    :  (2.*(n_)*(m_)*(k_) - (m_)*(k_)*(k_) + (m_)*(k_) + (n_)*(k_) - 0.5*(k_)*(k_) + 0.5*(k_)))
#define FADDS_UNMQR(m_, n_, k_, side_) (( ((side_)) == 141 ) \
...
#define FLOPS_ZUNMQR(m_, n_, k_, side_) (6. * FMULS_UNMQR((m_), (n_), (k_), (side_)) + 2.0 * FADDS_UNMQR((m_), (n_), (k_), (side_)) )
#define FLOPS_CUNMQR(m_, n_, k_, side_) (6. * FMULS_UNMQR((m_), (n_), (k_), (side_)) + 2.0 * FADDS_UNMQR((m_), (n_), (k_), (side_)) )
#define FLOPS_DORMQR(m_, n_, k_, side_) (     FMULS_UNMQR((m_), (n_), (k_), (side_)) +       FADDS_UNMQR((m_), (n_), (k_), (side_)) )
#define FLOPS_SORMQR(m_, n_, k_, side_) (     FMULS_UNMQR((m_), (n_), (k_), (side_)) +       FADDS_UNMQR((m_), (n_), (k_), (side_)) )
